...
A food nutrition retrieval app that scans product barcodes and generates nutritional information. The codebase can be deployed on any system-on-chip with a handheld scanner, enabling a portable, personal nutrition checker.
